...
const CONSTANTS_STATUS = {
   ...
   installationServiceRequestsStatusArr: [
      "PENDING",
      "ASSIGNED",
      "PROBLEM",
      "REJECTED",
   ...
   helpdeskServiceRequestsStatusArr: [
      "PENDING",
      "ASSIGNED",
      "PROBLEM",
      "REJECTED",
   ...
   // ProjectPostStatus: [ "ACTIVE", "INACTIVE", "ON_HOLD", "PENDING_APPROVAL", "EXPIRED" ],
};
