      ...
      if (response.data && response.status === 200) {
         if (response.data.resourceData) {
            dispatch({
               ...
               data: {
                  userData: response.data.resourceData,
                  records: response.data.records,
                  currentPage: data?.pageNo,
                  rowsPerPage: data?.pageSize,
                  searchStr: data?.searchString,
                  city: data?.searchByCity,
                  location: data?.searchByzipCode,
...
export const addImage = async (data) => {
   ...
   if (response.data.status) {
      if (response.data && response.data.status === 200) {
         ...
         showErrorToast("Image not uploaded");
      else showErrorToast(response.data.message);
   }
   return response;
};
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            ...
            data: {
               consumersData: response.data.resourceData,
               records: response.data.records,
               currentPage: data.pageNo,
               rowsPerPage: data.pageSize,
               searchStr: data.searchString,
...
export const getConsumerTransactionsData = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            type: Actions.CONSUMER_TRANSACTIONS_DATATABLE_SUCCESS,
            data: response.data.resourceData,
         });
...
export const getRefundRequestListData = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            type: Actions.REFUND_REQUESTS_DATATABLE_SUCCESS,
            data: response.data.resourceData,
         });
...
export const getPayablePartnerCommisionsListData = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            type: Actions.PAYABLE_PARTNER_COMMISIONS_DATATABLE_SUCCESS,
            data: response.data.resourceData,
         });
      } else
         dispatch({
            type: Actions.PAYABLE_PARTNER_COMMISIONS_DATATABLE_ERROR,
            data: response.data,
         });
   }
};
...
export const getAllFinanceTeamsData = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            type: Actions.FINANCE_TEAM_DATATABLE_SUCCESS,
            data: response.data.resourceData,
         });
...
export const getRefundRequestDetails = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            type: Actions.FINANCE_REFUND_REQUEST_DETAILS_SUCCESS,
            data: response.data.resourceData,
         });
...
export const getAllTransactionMeetingRequest = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200 && response.data.resourceData) {
         dispatch({
            type: Actions.TRANSACTION_MEETING_REQUEST_SUCCESS,
            data: response.data.resourceData,
         });
...
export const getAllTransactionTeamsCity = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200) {
         if (response.data.resourceData) {
            dispatch({
               type: Actions.TRANSACTION_TEAM_CITY_SUCCESS,
               data: response.data.resourceData,
            });
         }
      }
...
export const getAllAgencyExecutives = (data) => async (dispatch) => {
   ...
   if (response.status === 200) {
      return dispatch({
         ...
         data: {
            executives: response.data.resourceData,
            records: response.data.records,
            currentPage: data.pageNo,
            rowsPerPage: data.pageSize,
...
export const getAgencyCustomers = (data) => async (dispatch) => {
   ...
   if (response.status === 200) {
      return dispatch({
         ...
         data: {
            customerData: response.data.resourceData,
            records: response.data.records,
            currentPage: data.pageNo,
            rowsPerPage: data.pageSize,
            fromDate: data.fromDate,
...
export const getBrokerListing = (data) => async (dispatch) => {
   ...
   if (response) {
      if (response.data && response.status === 200) {
         dispatch({
            type: Actions.BROKERS_MODULE_SUCCESS,
            data: {
               brokerList: response.data.resourceData,
               records: response.data.records,
               currentPage: data.pageNo,
               rowsPerPage: data.records,
...
export const getBrokerPostedProperty = (data) => async (dispatch) => {
   ...
   if (response.status === 200) {
      dispatch({
         type: Actions.BROKERS_PROPERTY_SUCCESS,
         data: {
            brokerProperty: response.data.resourceData === null ? [] : response.data.resourceData,
            records: response.data.records,
            currentPage: data.pageNo,
            rowsPerPage: data.records,
            searchString: data.searchString,
...
export const getAllCorporates = (data) => async (dispatch) => {
   ...
   if (response.status === 200) {
      dispatch({
         type: Actions.CORPORATE_LIST_SUCCESS,
         data: {
            corporateList: response.data.resourceData,
            currentPage: data.pageNo,
            rowsPerPage: data.pageSize,
            searchString: data.searchString,
         },
...
export const BuilderLogin = (data) => async (dispatch) => {
   const response = await mainApiService("Builderlogin", data);
   if (response.data.access_token) {
      setLocalStorage("authData", response.data);
   }
   dispatch({ type: Actions.ADMIN_AUTH_DATA, data: response.data });
