...
const UnInstalledKitList = (props) => {
        ...
        <>
            <div className="tableBox ">
                <div className="align-items-center tableHeading">
                    <div className="locationSelect d-flex mt-2" style={{justifyContent:'space-between'}}>
                        <Text text="Un Installed Kits" style={{fontSize:'20px', fontWeight:'800'}} ></Text>
...
export default compose(connect(mapStateToProps, actions))(UnInstalledKitList);