...
const SubProjectDetails = (props) => {
    ...
    const handleFetchUnit = (unitDetails) => {
        ...
        if (editUnitFlag) {
            units = units.map(unit =>
                unit.propertyId === editPropertyId ? unitDetails : unit
            );
        } else {
    ...
    return (
        <>
            <div>
                <Text text={'Tower Basic Specification'} style={{ fontSize: '18px', fontWeight: '700' }} />
                <Row>
                    ...
                    <Col lg={3} className='mt-3' >
                        ...
                        <Text text={(subProjectDetails?.totalAreaToDevelop || '0') + " Sq. Ft."} style={{ fontSize: '14px', fontWeight: '500' }} />
                    </Col>
                    <Col lg={3} className='mt-3' >
                        <Text text={'Total Floors'} style={{ fontSize: '12px', fontWeight: '500', color: '#949494' }} />
                        <Text text={subProjectDetails?.totalFloors || '0'} style={{ fontSize: '14px', fontWeight: '500' }} />
                    </Col>
                    <Col lg={3} className='mt-3' >
                        <Text text={'Units per Floor'} style={{ fontSize: '12px', fontWeight: '500', color: '#949494' }} />
                        <Text text={subProjectDetails?.unitsPerFloor || '0'} style={{ fontSize: '14px', fontWeight: '500' }} />
                    </Col>
                    <Col lg={3} className='mt-3' >
                    ...
                    <Col lg={3} className='mt-3' >
                        ...
                        <Text text={subProjectDetails?.highlights || 'N/A'} style={{ fontSize: '14px', fontWeight: '500' }} />
                    </Col>
                    <Col lg={3} className='mt-3' >
                    ...
                    <>
                        <Row className='mt-3'>
                            <Col>
                                ...
                                <Text text={property?.propertySubType + ' - ' + (property?.compositionType?.trim() || 'N/A')} style={{ fontSize: '14px', fontWeight: '500' }} />
                            </Col>
                            <Col>
                            ...
                            {property?.propertySubType === 'Plot' ?
                                <>
                                    <Col>
                                        <Text text={'Plot Size'} style={{ fontSize: '12px', fontWeight: '500', color: '#949494' }} />
                                        <Text text={(property?.minArea || '0') + 'Sq.Ft.' + " - " + (property?.maxArea || '0') + 'Sq.Ft.'} style={{ fontSize: '14px', fontWeight: '500' }} />
                                    </Col>
                                </>
                                :
                                <Col>
                            ...
                            <Col>
                                ...
                                <Text text={setPrice(Number(property?.minPrice)) + "-" + setPrice(Number(property?.maxPrice))} style={{ fontSize: '14px', fontWeight: '500' }} />
                            </Col>
                            {/* <Col>
                        ...
                        <div style={{ justifySelf: 'end' }}>
                            <Buttons name="Edit Unit" varient="primary" onClick={() => { setEditUnitFlag(true); setEditPropertyId(property?.propertyId) }} />
                        </div>
                        <hr />
            ...
            <div>
                <Button
                    ...
                    onClick={() => {
                        if (subProjectDetails.propertyType !== null && subProjectDetails.propertyType.length !== 0) {
