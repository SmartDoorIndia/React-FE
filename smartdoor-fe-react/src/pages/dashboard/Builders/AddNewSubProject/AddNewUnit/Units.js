...
const Units = (props) => {
   ...
   const handleConfigurationChange = (e) => {
      if (subProjectDetails.subPostType === "Tower") {
         const [rooms, compositionType] = e.target.value.split(" "); // Split value into numberOfRooms and propertyRoomCompositionType
         ...
         let unitFields =
            UnitPostingFields.unitPostingFieldsObj[subProjectDetails.subPostType][compositionType]
               .fields;
         ...
         let unitFields =
            UnitPostingFields.unitPostingFieldsObj[subProjectDetails.subPostType][e.target.value]
               .fields;
         console.log(unitFields);
         setUnitFieldsList([...unitFields]);
      }
   ...
   useEffect(() => {
      console.log(props);
      let unitFields =
         UnitPostingFields.unitPostingFieldsObj[
            subProjectDetails?.propertyType ? subProjectDetails?.propertyType : "Residential"
         ][props?.property?.propertySubType ? props?.property?.propertySubType : "Apartment"]
            ?.fields;
      console.log(unitFields);
      setUnitFieldsList([...unitFields]);
      if (props?.builderId !== null && props?.projectId !== null) {
         setUnitDetails((prevData) => ({
            ...
            builderProjectId: props?.projectId,
         }));
      }
      if (editUnit) {
         setUnitDetails((prevData) => ({
            ...prevData,
            propertyImagesList: props?.property?.propertyImagesList,
            minPrice: unitDetails.minPrice / 100000,
            maxPrice: unitDetails.maxPrice / 100000,
         }));
      }
   }, []);
                  ...
                  <Col xs={12} sm={6} md={3} style={{ paddingLeft: "20px", paddingRight: "20px" }}>
                     ...
                     <TextField
                        ...
                        onChange={(e) => {
                           ...
                           let unitFields =
                              UnitPostingFields.unitPostingFieldsObj[
                                 subProjectDetails?.propertyType
                     ...
                     >
                        ...
                        {subProjectDetails.subPostType === "Tower"
                           ? [
                                ...
                                <MenuItem
                                   key="Independent House / Bungalow"
                                   value="Independent House / Bungalow"
                                >
                                 ...
                                 endAdornment: (
                                    <InputAdornment position="end" style={{ marginRight: "-8%" }}>
                                       <TextField
                                          ...
                                          value={
                                             unitDetails.builtUpAreaMeasurementUnitEnteredByUser ||
                                             ""
                                          }
                                       >
                                          <MenuItem value="" disabled>
                                 ...
                                 endAdornment: (
                                    <InputAdornment position="end" style={{ marginRight: "-8%" }}>
                                       <TextField
                                          ...
                                          value={
                                             unitDetails.plotAreaMeasurementUnitEnteredByUser || ""
                                          }
                                       >
                                          <MenuItem value="" disabled>
                                             Select
                                 ...
                                 endAdornment: (
                                    <InputAdornment position="end" style={{ marginRight: "-8%" }}>
                                       <TextField
                                          ...
                                          value={
                                             unitDetails.carpetAreaMeasurementUnitEnteredByUser ||
                                             "Sq. Ft."
                                          }
                                       >
                                          <MenuItem value="" disabled>
                  ...
                  {unitFieldsList.includes("floorPlan") ? (
                     <>
                        ...
                        <Col
                           ...
                           style={{ paddingLeft: "20px", paddingRight: "20px" }}
                        >
                           <Form.Group controlId="formProjectLayout" className="formProjectLayout">
                              {/* <span>Floor Plan Images</span> */}
                              <div className="image-upload mt-2">
                                 <label
                                    htmlFor="upload-project-layout"
                                 ...
                                 <div className="d-flex flex-wrap mt-2 justify-content-center">
                                    {unitDetails?.floorPlan?.map((image, index) => (
                                       <div
                                          key={index}
                                 ...
                                 {error?.floorPlan ? (
                                    <>
                                       <Text
                                          text={"Please add floor plan images"}
                                          style={{
                                             fontSize: "12px",
                                             fontWeight: "400",
                                             color: "red",
                        ...
                        >
                           <Form.Group controlId="formProjectLayout" className="formProjectLayout">
                              ...
                              <div className="image-upload mt-2">
                                 ...
                                 <div className="d-flex flex-wrap mt-2 justify-content-center">
                                    {unitDetails?.propertyImagesList?.map((image, index) => (
                                       <div
                                          key={index}
                                          className="project-images mt-3"
                                          style={{
                                 ...
                                 {error?.propertyImagesList ? (
                                    <>
                                       <Text
                                          text={"Please add property Images"}
                                          style={{
                                             fontSize: "12px",
                                             fontWeight: "400",
                                             color: "red",
               ...
               {addUnitFlag ? (
                  <div style={{ justifySelf: "end" }}>
                     <Buttons
                        ...
                        name={editUnit ? "Save" : "Save Unit"}
                        varient="primary"
                        onClick={() => {
                           saveBuilderSubProjectUnit();
                        }}
                     />
                  </div>
               ) : null}
