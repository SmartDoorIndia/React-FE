...
const FinanceListingPage = React.lazy(() =>
   import("./FinanceModule/FinanceListingPage/FinanceListingPage")
);
const FinanceRefundRequest = React.lazy(() =>
   import("./FinanceModule/FinanceRefundRequest/FinanceRefundRequest")
);
...
const TransactionDetailsPage = React.lazy(() =>
   import("./TransactionDashboard/TranscationDetails/TransactionDetails")
);
const TransactionListingPage = React.lazy(() =>
   import("./TransactionDashboard/TransactionListing/TransactionListing")
);
const DealApprovalDetailPage = React.lazy(() =>
   import("./TransactionDashboard/DealApproval/DealApproval")
);
...
const routeData = [
   ...
   {
      path: "/admin/properties/property-details",
      name: "Properties",
      bradcrumb: ["Add New Posting", "Property Details"],
      excat: true,
      // module:'MARKETING',
      component: PropertyDetailsModule,
   },
