        ...
        <>
            <div className="whiteBg" style={{ marginBottom: '0%' }}>
                <div className="d-flex">
                    ...
                    <div>
                        <Button disabled={userData.active ? false : true} size="sm" variant='outlined' className='mb-2 w-90 text-capitalize' style={{ color: '#BE1452', borderColor: '#BE1452' }} onClick={() => {
                        ...
                        <Button disabled={userData.active ? false : true} size="sm" variant='primary' className='mb-2 w-90 text-capitalize' style={{ color: 'white', backgroundColor: '#BE1452' }} onClick={() => { setShowAwardCouponsModal(true) }}>Award Coupons</Button>
                    </div>
                </div>
            </div>
