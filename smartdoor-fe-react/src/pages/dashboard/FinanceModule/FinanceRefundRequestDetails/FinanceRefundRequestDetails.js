                              ...
                              <div className="leadTitle">
                                 <div className="d-flex align-items-center">
                                    ...
                                    <Text
                                       ...
                                       fontWeight="regularbold"
                                       color="secondryColor"
                                       text={handleStatusElement(data.status)}
                                    />
                                 </div>
                              ...
                              <div className="locationSelect">
                                 ...
                                 {data?.status === "CLOSED" ? (
                                    <Buttons
                                       ...
                                       color="white"
                                       onClick={() =>
                                          handlefinanceStatus(buybackRequestId, "REOPEN")
                                       }
                                    />
                                 ) : (
                                    ""
                                 ...
                                 {data?.status === "PENDING" || data?.status === "IN_PROGRESS" ? (
                                    <Buttons
                                       ...
                                       color="white"
                                       onClick={() =>
                                          handlefinanceStatus(buybackRequestId, "CLOSED")
                                       }
                                    />
                                 ) : (
                                    ""
                              ...
                              <Col>
                                 <div>
                                    ...
                                    <Link
                                       ...
                                       to={{
                                          pathname:
                                             "/admin/finance/refundRequest-details/property-details",
                                          state: {
                                 ...
                                 <Col>
                                    <div>
                                       ...
                                       <Text
                                          ...
                                          fontWeight="mediumbold"
                                          color="secondryColor"
                                          text={data?.ifscCode ? data?.ifscCode : "-"}
                                       />
                                    </div>
                                 </Col>
                                 <Col>
                                    <div>
                                       ...
                                       <Text
                                          ...
                                          fontWeight="mediumbold"
                                          color="secondryColor"
                                          text={data?.bankName ? data?.bankName : "-"}
                                       />
                                    </div>
                                 </Col>
                                 <Col>
                                       ...
                                       <>
                                          <Col className="col-2">
                                             <div>
                                                ...
                                                {data.contactId !== null ? (
                                                   <Link
                                                      to={`/admin/helpdesk/property-leads/consumer-details/${data.contactId}`}
                                                   >
                                                      <Text
                                                         size="Small"
                                                         fontWeight="mediumbold"
                                       ...
                                       <>
                                          <Col xs={2}>
                                             <div>
                                                ...
                                                <Link
                                                   className="removeUnderline"
                                                   to={`/admin/consumer-management/consumer-details/${data.customerId}`}
                                                >
                                                   <Text
                                                      className="forLink"
                                                      size="Small"
                                          ...
                                          <Col xs={2}>
                                             <div>
                                                ...
                                                <Text
                                                   ...
                                                   fontWeight="mediumbold"
                                                   color="secondryColor"
                                                   text={data.customerContactNumber}
                                                />
                                             </div>
                                          </Col>
                                       </>
                                    ...
                                    <div className="mt-2 mb-3" key={index}>
                                       <div className="d-flex align-items-center mt-2">
                                          <Text
                                             ...
                                             fontWeight="mediumbold"
                                             color="secondryColor"
                                             text={`From: ${_value.feedBackByName || " - "}`}
                                          />
                                          <Text
                                             size="xSmall"
                                             fontWeight="smbold"
                                             color="TaupeGrey"
                                             text={formateDateTime(_value.date)}
                                             className="ml-2"
                                          />
                                       </div>
                                       ...
                                       <div className="d-flex align-items-center mt-0">
                                          <Text
                                             ...
                                             fontWeight="mediumbold"
                                             color="primaryColor"
                                             text={_value.clientInterest}
                                          />
                                          {_value.clientInterest === `Will decide later` ||
                                          _value.clientInterest ===
                                             "No, does not look interested" ? (
