...
const Login = (props) => {
  ...
  const handleLogin = async () => {
    ...
    props.actionGetOtp({ mobile: username })
      .then((response) => {
            ...
            <Col lg="4">
              <Form.Group controlId="formBasicEmail">
                ...
                <Form.Control
                  ...
                  autoFocus
                />
                <Text color="dangerText" size="xSmall" className="pt-2" text={error.username} autoFocus={true}/>
              </Form.Group>             
              <Buttons disabled={buttonDisable} name="Get OTP" varient="primary" type="submit" size="Small" color="primary" />
            </Col>
          </Row>
        </form>
      </div>
